...
function redraw(gl) {
    ...
    clipVertices1 = [
        0.3, 0.0, 0.3, -0.3, 0.2, -0.3, 0.2, -0.1, 0.0, -0.1, 0.0, 0.0,
    ];
    clipVertices2 = [
        -0.3, 0.0, -0.3, -0.3, -0.2, -0.3, -0.2, -0.1, 0.0, -0.1, 0.0, 0.0,
    ];
    ...
    buffer0 = initArrayBuffer(
        gl,
        new Float32Array(rectVertices),
        2,
        gl.FLOAT,
        "a_Position"
    );
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(4).fill(blueColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(362).fill(cyanColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(4).fill(whiteColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(3).fill(greenColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(4).fill(yellowColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(362).fill(redColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(2).fill(whiteColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer0 = initArrayBuffer(
        gl,
        new Float32Array(clipVertices1),
        2,
        gl.FLOAT,
        "a_Position"
    );
    buffer1 = initArrayBuffer(
        gl,
        new Float32Array(Array(6).fill(purpleColor).flat()),
        3,
        gl.FLOAT,
        "a_Color"
    );
    ...
    buffer0 = initArrayBuffer(
        gl,
        new Float32Array(clipVertices2),
        2,
        gl.FLOAT,
        "a_Position"
    );
